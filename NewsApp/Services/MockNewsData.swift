...
//  NewsApp
//
//  本地 Mock 数据 — 模拟 GraphQL 服务器返回的 JSON
//  当接入真实后端后，此文件可删除
//
...
enum MockNewsData {
    ...
    /// 按分类返回新闻列表的 GraphQL 响应 JSON
    static func newsFeedJSON() -> [String: Any] {
        return [
            "data": [
                "newsFeed": articles
            ]
    ...
    /// 按 ID 返回单篇文章的 GraphQL 响应 JSON
    static func articleJSON(id: String) -> [String: Any] {
        let article = articles.first { ($0["id"] as? String) == id }
        return [
            "data": [
    ...
    private static let articles: [[String: Any]] = [
        [
            "__typename": "NewsArticle",
            "id": "1",
            "title": "SpaceX Starship Completes Fifth Test Flight with Booster Catch",
            "summary": "SpaceX successfully caught the Super Heavy booster with the launch tower during the fifth Starship test flight.",
            ...
            "imageUrl": "https://picsum.photos/seed/spacex/400/300",
            "source": "Space News",
            "publishedAt": "2h ago",
            "category": "science"
        ],
        [
            ...
            "summary": "Apple announced its next-generation M5 chip built on 3nm process, delivering 40% faster CPU and 50% faster GPU.",
            ...
            "imageUrl": "https://picsum.photos/seed/apple5/400/300",
            "source": "The Verge",
            "publishedAt": "3h ago",
            "category": "tech"
        ],
        [
            ...
            "summary": "The WHO has approved a second-generation malaria vaccine with 78% efficacy for children in high-risk regions.",
            ...
            "imageUrl": "https://picsum.photos/seed/malaria/400/300",
        ...
        [
            ...
            "summary": "Researchers used deep learning to screen 100 million compounds in 30 days, identifying a novel antibiotic effective against drug-resistant bacteria.",
            ...
            "imageUrl": "https://picsum.photos/seed/aidrug/400/300",
        ...
        [
            ...
            "summary": "Tesla has opened its autonomous ride-hailing service to the public in San Francisco with 500 vehicles.",
            ...
            "imageUrl": "https://picsum.photos/seed/tesla/400/300",
            "source": "TechCrunch",
            "publishedAt": "8h ago",
            "category": "tech"
        ],
        [
            ...
            "summary": "The IEA reports renewable sources exceeded 50% of global electricity production for the first time in Q1 2026.",
            ...
            "imageUrl": "https://picsum.photos/seed/renew/400/300",
        ...
        [
            ...
            "summary": "A Phase 3 trial shows CRISPR-based gene therapy eliminated sickle cell crises in 94% of patients.",
            ...
            "imageUrl": "https://picsum.photos/seed/crispr/400/300",
            "source": "NEJM",
            "publishedAt": "12h ago",
            "category": "medical"
        ]
